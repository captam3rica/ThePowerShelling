...
- Now prompts the user before removing each device.
- Remove-CMDevice is now called only once per device.
- The script now prints the name of each device before it is removed.
- Changes to syntax and formatting.
